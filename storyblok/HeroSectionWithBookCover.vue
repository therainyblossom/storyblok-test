  ...
  >
    <div class="max-w-screen-xl px-4 py-8 mx-auto lg:px-6 sm:py-16 lg:py-24">
      <div class="flex flex-col items-center gap-8 xl:gap-16 lg:flex-row">
          ...
          <div class="flex items-center justify-center gap-5 mt-8 lg:justify-start sm:gap-6">
            ...
            <div>
              <div class="flex items-center gap-1.5">
                ...
                <span class="text-base font-normal text-gray-500 dark:text-gray-400"> 5.0 </span>
              </div>
              <p class="mt-1 text-sm font-normal text-gray-500 dark:text-gray-400">
                Rated Best Over
                <span class="font-semibold text-gray-900 dark:text-white">15.7k</span> Reviews
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="max-w-md">
          <img
            v-if="blok.image?.is_external_url"
