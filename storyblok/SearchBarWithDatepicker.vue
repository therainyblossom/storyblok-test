...
const { optimizedUrl: bgUrl } = useImageHandler(
  props.blok.background?.filename,
  props.blok.background?.is_external_url
)
</script>
...
<template>
  ...
  >
    <div class="relative py-8 px-4 mx-auto max-w-screen-xl text-white lg:py-16 z-1 md:px-8">
