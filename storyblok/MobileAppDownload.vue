    ...
    >
      <div>
        ...
        <div class="items-center space-y-4 sm:flex sm:space-y-0 sm:space-x-4">
          <NuxtLink
            :to="useFormatUrl(blok.link_ios?.story?.full_slug || blok.link_ios?.cached_url)"
            :target="blok.link_ios?.target"
          ...
          <NuxtLink
            :to="useFormatUrl(blok.link_android?.story?.full_slug || blok.link_android?.cached_url)"
            :target="blok.link_android?.target"
            class="w-full sm:w-auto bg-gray-800 hover:bg-gray-700 focus:ring-4 focus:outline-none focus:ring-gray-300 text-white rounded-lg inline-flex items-center justify-center px-4 py-2.5 dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-gray-800"
          >
            <svg
              class="mr-3 w-7 h-7"
