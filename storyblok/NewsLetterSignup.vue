    ...
    <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
      <div class="mx-auto max-w-screen-md sm:text-center">
        ...
        <form action="#">
          ...
          <div
            v-html="renderedDescription(blok.information_text)"
            class="mx-auto max-w-screen-sm text-sm text-left text-gray-500 newsletter-form-footer dark:!text-white"
          ></div>
        </form>
      </div>
    </div>
