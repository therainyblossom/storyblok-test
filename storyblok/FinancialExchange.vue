    ...
    >
      <div class="max-w-screen-xl px-4 py-8 mx-auto text-center lg:py-16 ">
        ...
        <div class="grid gap-6 lg:gap-8 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-5">
          <template v-for="inblok in blok.information" :key="inblok._uid">
            <StoryblokComponent :blok="inblok" />
          </template>
        </div>
        <div class=" mt-8 lg:mt-12 border border-gray-200 rounded-lg dark:border-gray-700">
          <div class="mx-auto mb-8 border-b border-gray-100 dark:border-gray-700 w-fit">
            <ul
